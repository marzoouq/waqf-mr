...
| الجداول/العروض | 39 (35 جدول أصلي + 2 عرض آمن + `invoice_chain` + `invoice_items`) |
| الدوال المخزنة | 73 دالة |
| المشغلات النشطة | 53 |
| Edge Functions | 14 وظيفة |
| مهام مجدولة (pg_cron) | 13 مهمة |
...
| 2 | **قاعدة البيانات** | مخطط ERD، 39 جدول/عرض، الأعمدة، سياسات RLS، 73 دالة، 53 مشغل | [DATABASE.md](./DATABASE.md) |
| 3 | **واجهة البرمجة** | توثيق 14 Edge Function مع أمثلة الاستدعاء | [API.md](./API.md) |
