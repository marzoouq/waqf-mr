...
| الجداول/العروض | 39 (37 جدول + 2 عرض آمن) |
| الدوال المخزنة | 72 دالة |
| المشغلات النشطة | 53 |
| Edge Functions | 16 وظيفة |
| مهام مجدولة (pg_cron) | 12 مهمة |
| سياسات RLS | 134 سياسة |
...
| 2 | **قاعدة البيانات** | مخطط ERD، 39 جدول/عرض، الأعمدة، سياسات RLS، 72 دالة، 53 مشغل | [DATABASE.md](./DATABASE.md) |
| 3 | **واجهة البرمجة** | توثيق 16 Edge Function مع أمثلة الاستدعاء | [API.md](./API.md) |
...
### 🗄️ قاعدة البيانات
← [DATABASE.md](./DATABASE.md) — 39 جدول/عرض، 53 مشغل، علاقات، سياسات أمان، 72 دالة مخزنة

### 🔌 الواجهات البرمجية
← [API.md](./API.md) — 16 Edge Function: إدارة المستخدمين، المساعد الذكي، تنبيهات انتهاء العقود، البحث بالهوية، حماية التسجيل، توليد فواتير PDF، المصادقة البيومترية (WebAuthn)، قوالب البريد، ZATCA (XML Generator + Signer + Onboard + Report + Renew)، ملخص لوحة التحكم، ملخص المستفيد، فحص صحة النظام
