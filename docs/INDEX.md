...
| البند | القيمة |
|-------|--------|
| تاريخ الفحص | 2026-02-20 (الجولة 12) |
...
| 2 | **قاعدة البيانات** | مخطط ERD، 19 جدول/عرض، الأعمدة، سياسات RLS، 8 دوال، 29 مشغل | [DATABASE.md](./DATABASE.md) |
...
### 🗄️ قاعدة البيانات
← [DATABASE.md](./DATABASE.md) — 19 جدول/عرض، 29 مشغل، علاقات، سياسات أمان، 8 دوال مخزنة

### 🔌 الواجهات البرمجية
← [API.md](./API.md) — 8 Edge Functions: إدارة المستخدمين، المساعد الذكي (gemini-2.5-pro)، انتهاء العقود، تنبيهات العقود، البحث بالهوية، حماية التسجيل، توليد فواتير PDF
