...
describe('entities PDF', () => {
  ...
  it('generatePropertiesPDF saves correctly', async () => {
    ...
    expect(mockFinalizePdf).toHaveBeenCalledWith(expect.anything(), expect.anything(), 'properties-report.pdf');
  });
  ...
  it('generateContractsPDF saves correctly', async () => {
    ...
    expect(mockFinalizePdf).toHaveBeenCalledWith(expect.anything(), expect.anything(), 'contracts-report.pdf');
  });
  ...
  it('generateBeneficiariesPDF saves correctly', async () => {
    ...
    expect(mockFinalizePdf).toHaveBeenCalledWith(expect.anything(), expect.anything(), 'beneficiaries-report.pdf');
  });
