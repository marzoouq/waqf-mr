 ...
 * ملف مجمّع يُعيد تصدير كل الفحوصات من ملفاتها المنفصلة
 */
...
export { checkNavigatorLocks, checkScrollPerformance, checkDomNodesCount, checkDeviceMemory, checkWebAssembly, checkPagePerformance, checkWcagContrast } from './checks/performance';
...
export { checkCryptoAPI, checkNotificationPermission, checkClipboardAPI, checkWindowOnError } from './checks/security';
...
import { checkNavigatorLocks, checkScrollPerformance, checkDomNodesCount, checkDeviceMemory, checkWebAssembly, checkPagePerformance, checkWcagContrast } from './checks/performance';
...
import { checkCryptoAPI, checkNotificationPermission, checkClipboardAPI, checkWindowOnError } from './checks/security';
