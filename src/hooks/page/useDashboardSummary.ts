 ...
 * يستدعي Edge Function `dashboard-summary` ويوزّع البيانات على React Query caches
 */
...
export const useDashboardSummary = (fiscalYearId: string, fiscalYearLabel?: string) => {
  ...
  // تعبئة React Query caches بالبيانات المجلوبة لتفادي طلبات مكررة من الصفحات الأخرى
  useEffect(() => {
