...
export const adminRoutes = (
  <>
    ...
    <Route path="/dashboard/audit-report-final" element={pr(ADMIN_ONLY, <AuditReportFinalPage />, false)} />
    <Route path="/dashboard/cleanup-report" element={pr(ADMIN_ONLY, <CleanupReportPage />, false)} />
  </>
);
