...
export const ADMIN_ROUTES: Record<string, RouteMeta> = {
  ...
  '/dashboard/archive': { title: 'أرشيف الوثائق', labelKey: 'archive', permKey: 'archive', sectionKey: 'archive' },
...
export const BENEFICIARY_ROUTES: Record<string, RouteMeta> = {
  ...
  '/beneficiary/archive': { title: 'أرشيف الوثائق', permKey: 'archive', sectionKey: 'archive' },
