/**
 * جدول التدفق النقدي الشهري — mobile + desktop
 */
...
interface CashFlowTableProps {
  ...
  totals: { totalIncome: number; totalExpenses: number; totalNet: number };
  fmt: (v: number) => string;
}

export default function CashFlowTable({ monthlyData, totals, fmt }: CashFlowTableProps) {
  return (
