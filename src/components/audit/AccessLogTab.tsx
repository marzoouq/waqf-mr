    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-wrap gap-3">
        <div className="relative flex-1 min-w-[200px]">
          ...
          <Input name="searchQuery" id="access-log-tab-field-1" placeholder="بحث في كامل السجلات (بريد، مسار، جهاز)..." title="بحث خادمي عبر كل سجلات الوصول — يُؤجَّل 300ms أثناء الكتابة" value={searchQuery} onChange={e => setSearchQuery(e.target.value)} className="ps-9" />
        </div>
