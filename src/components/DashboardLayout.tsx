    ...
    <>
      ...
      <div className="flex items-center justify-between p-4 border-b border-sidebar-border">
        <div className={cn('flex items-center gap-3', !sidebarOpen && 'lg:justify-center')}>
          ...
          <span className={cn('font-bold text-sidebar-foreground', !sidebarOpen && 'lg:hidden')}>إدارة الوقف</span>
        </div>
        {/* Desktop toggle */}
        <Button
          variant="ghost"
  ...
  return (
    <div className="min-h-screen flex w-full bg-background">
      ...
      <div className="fixed top-0 right-0 left-0 z-40 flex items-center justify-between p-3 gradient-hero lg:hidden">
        ...
        <span className="font-bold text-sidebar-foreground">إدارة الوقف</span>
        <div className="w-10" />
      </div>
