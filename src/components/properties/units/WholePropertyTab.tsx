          ...
          <CardContent className="pt-4">
            <form onSubmit={handleSubmit} className="space-y-3">
              ...
              <div className="grid grid-cols-2 md:grid-cols-3 gap-3">
                ...
                <div className="space-y-1">
                  <Label htmlFor="whole-property-tab-field-3" className="text-xs">نوع الدفع</Label>
                  <NativeSelect id="whole-property-tab-field-3" value={form.payment_type} onValueChange={(v) => setForm({ ...form, payment_type: v })} options={PAYMENT_TYPES} />
                </div>
