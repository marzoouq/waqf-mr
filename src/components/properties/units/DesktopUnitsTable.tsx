...
import { getPaymentStatusFromInvoices, getMonthlyRent, getTenantFromContracts, getMonthlyFromContract } from '@/utils/properties/units';
        ...
        <TableBody>
                  ...
                  {!tenant ? <span className="text-muted-foreground">-</span> : (
                    <span className="whitespace-nowrap">
                      ...
                      {tenant.status !== 'active' && (
                        <Badge variant="outline" className="ms-2 text-[11px] px-1.5 py-0 text-destructive border-destructive/30">منتهي</Badge>
                      )}
                    </span>
                  )}
                </TableCell>
          ...
          <TableRow className="bg-primary/10 font-bold border-t-2">
            <TableCell colSpan={3} className="text-right">
              الإجمالي <Badge variant="outline" className="ms-2 text-[11px]">شامل النشط والمنتهي</Badge>
            </TableCell>
