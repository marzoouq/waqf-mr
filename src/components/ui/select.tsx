...
>(({ className, children, position = "popper", container, ...props }, ref) => {
  // Auto-detect if inside a Dialog and use its container to prevent React 19 portal conflicts
  const dialogContainer = React.useContext(DialogContainerContext);
  const portalContainer = container ?? (dialogContainer as HTMLElement | null) ?? undefined;
