...
const ExpenseBudgetBar = ({ expenses, fiscalYearId, isClosed }: ExpenseBudgetBarProps) => {
  ...
  // حساب المصروف الفعلي + أنواع الميزانية + خريطة الميزانيات في useMemo واحد
                  ...
                  {!isClosed && (
                    editingType === type ? (
                      <div className="flex items-center gap-1">
                        <Input name="editValue" id="expense-budget-bar-field-1" type="number"
                          value={editValue}
