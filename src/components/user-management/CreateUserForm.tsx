    ...
    <DialogContent>
      ...
      <form
        onSubmit={(e) => {
          ...
          if (!/^\d{10}$/.test(form.nationalId)) {
            uiNotify.error('رقم الهوية يجب أن يتكون من 10 أرقام بالضبط');
            return;
          }
      ...
      >
        <div className="space-y-2">
          ...
          <Input name="name" id="create-user-form-field-1" type="text" value={form.name} onChange={(e) => setForm({ ...form, name: e.target.value })} placeholder="أدخل اسم المستخدم" required />
        </div>
        <div className="space-y-2">
          <Label htmlFor="create-user-form-field-2">البريد الإلكتروني</Label>
          <Input name="email" id="create-user-form-field-2" type="email" value={form.email} onChange={(e) => setForm({ ...form, email: e.target.value })} placeholder="user@example.com" dir="ltr" required />
        </div>
        <div className="space-y-2">
        ...
        <div className="space-y-2">
          ...
          <Input name="nationalId" id="create-user-form-field-3"
            type="text"
