/**
 * جدول العقود لسطح المكتب — مستخرج من ContractsViewPage
 */
...
interface ContractDesktopTableProps {
  contracts: ContractItem[];
  propertiesMap: Record<string, string>;
  isExpiringSoon: (c: { status: string | null; end_date: string | null }) => boolean;
}

const ContractDesktopTable = ({ contracts, propertiesMap, isExpiringSoon }: ContractDesktopTableProps) => (
...
export default ContractDesktopTable;
