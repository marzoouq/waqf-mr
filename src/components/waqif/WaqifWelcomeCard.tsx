...
const WaqifWelcomeCard = ({ displayName, greeting, GreetingIcon, hijriDate, gregorianDate, timeStr }: WaqifWelcomeCardProps) => (
...
export default WaqifWelcomeCard;
