        ...
        <div className="flex items-center justify-between flex-wrap gap-2">
          ...
          <div className="flex items-center gap-2">
            <div className="relative">
              ...
              <Input name="errorSearch" id="support-errors-tab-field-1" placeholder="بحث في الأخطاء..." value={errorSearch} onChange={e => setErrorSearch(e.target.value)} className="ps-8 w-[180px]" />
            </div>
