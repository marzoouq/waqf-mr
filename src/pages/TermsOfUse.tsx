  ...
  const sections = [
    {
      ...
      content: 'باستخدامك لنظام إدارة وقف مرزوق بن علي الدبشي، فإنك توافق على الالتزام بهذه الشروط والأحكام. إذا لم توافق على أي من هذه الشروط، يُرجى عدم استخدام النظام.',
    },
    {
      title: 'وصف الخدمة',
