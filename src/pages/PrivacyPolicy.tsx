...
const PrivacyPolicy = () => {
  ...
  const sections = [
    {
      title: 'المقدمة',
      content: 'نلتزم في نظام إدارة وقف مرزوق بن علي الدبشي بحماية خصوصية مستخدمي النظام. توضح هذه السياسة كيفية جمع واستخدام وحماية بياناتك الشخصية عند استخدامك لمنصتنا.',
    },
    {
