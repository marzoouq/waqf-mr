  ...
  const handleExportPdf = async () => {
    ...
    try {
      ...
      await generateYearComparisonPDF({
        ...
        netChange: (() => { const n0 = d0.waqfRevenue ?? (d0.totalIncome - d0.totalExpenses); const n1 = d1.waqfRevenue ?? (d1.totalIncome - d1.totalExpenses); return n0 ? ((n1 - n0) / Math.abs(n0)) * 100 : 0; })(),
