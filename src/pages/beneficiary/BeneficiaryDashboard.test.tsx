...
vi.mock('@/hooks/domain/financial/useFiscalYears', () => ({
...
vi.mock('@/hooks/domain/financial/useTotalBeneficiaryPercentage', () => ({
...
describe('BeneficiaryDashboard', () => {
  ...
  it('shows share amounts when year is closed', async () => {
    ...
    const { useBeneficiaryDashboardData } = await import('@/hooks/page/beneficiary/dashboard/useBeneficiaryDashboardData');
