...
BEGIN
  ...
  IF v_account_id IS NOT NULL THEN
    UPDATE accounts SET
      ...
      waqf_capital = p_waqf_corpus_manual,
  ...
  ELSE
    INSERT INTO accounts (
      ...
      distributions_amount, waqf_capital, net_after_expenses,
  ...
  -- Step 3: Create next fiscal year (N-02 fix: start = end_date + 1 day)
  ...
  IF NOT EXISTS (SELECT 1 FROM accounts WHERE fiscal_year_id = v_next_fy_id) THEN
    INSERT INTO accounts (
      ...
      waqf_revenue, vat_amount, distributions_amount, waqf_capital,
