...
BEGIN
  ...
  -- ═══ الإيرادات التعاقدية (مقيّدة بالسنة المالية المختارة) ═══
  -- الأولوية 1: مجموع المخصصات (contract_fiscal_allocations) لهذه السنة.
  -- الأولوية 2 (Fallback): مجموع rent_amount للعقود التي fiscal_year_id = v_fy_id فقط.
  -- لا يُخلط بين السنوات بأي حال.
