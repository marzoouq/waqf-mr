...
-- سحب الصلاحية من المجهول
REVOKE EXECUTE ON FUNCTION public.get_beneficiary_dashboard(uuid) FROM anon;
GRANT EXECUTE ON FUNCTION public.get_beneficiary_dashboard(uuid) TO authenticated;
