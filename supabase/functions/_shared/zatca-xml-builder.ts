 ...
 * بناء مستند UBL XML متوافق مع متطلبات ZATCA
 * تم استخراجه من zatca-xml-generator/index.ts لإعادة الاستخدام وسهولة الصيانة
 */
 ...
 */
export function getInvoiceTypeInfo(invoiceType: string): { code: string; name: string } {
 ...
 */
export function getVatCategoryCode(vatRate: number, exemptionCode?: string): string {
 ...
 */
export function getTaxExemptionInfo(vatCategoryCode: string, invoiceDescription?: string): { code: string; reason: string } | null {
