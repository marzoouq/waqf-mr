...
| `beneficiary/InvoicesViewPage.tsx` | `/beneficiary/invoices` | ALL_NON_ACCOUNTANT | 3 | 3 | 0 | 0 | 0 | ✅ 0 |
...
| `dashboard/ContractsPage.tsx` | `/dashboard/contracts` | ADMIN_ROLES | 2 | 1 | 0 | 2 | 0 | ✅ 0 |
...
| `dashboard/InvoicesPage.tsx` | `/dashboard/invoices` | ADMIN_ROLES | 3 | 5 | 0 | 0 | 0 | ✅ 0 |
...
| `dashboard/SettingsPage.tsx` | `/dashboard/settings` | ADMIN_ONLY | 1 | 0 | 0 | 0 | 0 | ✅ 0 |
| `dashboard/SupportDashboardPage.tsx` | `/dashboard/support` | ADMIN_ROLES | 3 | 1 | 0 | 0 | 0 | ✅ 0 |
